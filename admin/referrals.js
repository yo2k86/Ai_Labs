...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Loop satu per satu untuk mengecek siapa yang pakai kode
        for (const userDoc of usersSnapshot.docs) {
            ...
            if (profileDoc.exists) {
                ...
                if (data.redeemedCode) {
                    usedCodesMap[data.redeemedCode.toUpperCase()] = data.email || userDoc.id;
                }
            }
        }
        ...
        const result = allCodes.map(code => {
            ...
            return {
                code: upperCode,
                used: !!usedCodesMap[upperCode], // True jika ada pemakai
